...
type BillingEntityInput struct {
	Code                      string   `json:"code"`
	Name                      string   `json:"name,omitempty"`
	LegalName                 string   `json:"legalName,omitempty"`
	LegalNumber               string   `json:"legalNumber,omitempty"`
	...
	EmailSettings             []string `json:"emailSettings,omitempty"`
}
...
func (c *Client) CreateBillingEntity(ctx context.Context, input BillingEntityInput) (*BillingEntity, error) {
	var out BillingEntity
	if err := c.call(ctx, svcOrganization, "CreateBillingEntity", &input, &out); err != nil {
		return nil, err
	}
	return &out, nil
}

func (c *Client) UpdateBillingEntity(ctx context.Context, id string, input BillingEntityInput) (*BillingEntity, error) {
	type updateReq struct {
		BillingEntityInput
		ID string `json:"id"`
	}
	req := updateReq{BillingEntityInput: input, ID: id}
	var out BillingEntity
	if err := c.call(ctx, svcOrganization, "UpdateBillingEntity", &req, &out); err != nil {
		return nil, err
	}
	return &out, nil
}

func (c *Client) FindBillingEntityByCode(ctx context.Context, code string) (*BillingEntity, error) {
	var out BillingEntity
	req := map[string]string{"code": code}
	if err := c.call(ctx, svcOrganization, "GetBillingEntity", req, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
