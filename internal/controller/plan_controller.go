...
// +kubebuilder:rbac:groups=billing.bdaya-dev.com,resources=billingplans,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=billing.bdaya-dev.com,resources=billingplans/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=billing.bdaya-dev.com,resources=billingplans/finalizers,verbs=update
