...
// calls authenticate with the instance token plus the x-zitadel-orgid
// acting-org header (the tenant GUID from spec.externalId), which the gateway
// validates against the trusted-resolver allowlist.
